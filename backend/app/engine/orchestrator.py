                ...
                for slave in slaves:
                    ...
                    p = mp.Process(
                        ...
                        args=(
                            ...
                            slave_cfg["inverse_copy"], slave_cfg["copy_modify"],
                            slave_cfg["sync_close"],
                            slave_cfg["daily_loss_enabled"], slave_cfg["daily_loss_limit"],
                            slave_cfg["daily_profit_enabled"], slave_cfg["daily_profit_limit"],
                            slave_cfg["delay_sec"], slave_cfg["magic_number"],
        ...
        try:
            p = mp.Process(
                ...
                args=(
                    ...
                    cfg["inverse_copy"], cfg["copy_modify"],
                    cfg["sync_close"],
